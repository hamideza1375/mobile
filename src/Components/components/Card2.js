...
const card2 = (p) => {
  ...
  const {border=[],coulumn1,coulumn2,coulumn3,coulumn4,coulumn5,coulumn6,h,c1,c2,c3,c4,c5,c6,bgcolor} =p

  return (
    <Span h={h?h:300} w={'90%'} as={'center'} br={4} border={border.length?border:[1]} {...p} >
