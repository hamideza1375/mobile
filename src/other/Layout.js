      ...
      <View style={{flex:1,overflow:'hidden'}}>
        {
          ...
          p.route.name === 'Home' &&
          <Drawer header={
          <SearchBar Register={p.width > 395 ?true:false} icon={'filter'} src={p.width > 460 ?require('../assets/images/logo.png'):false} iconPress={()=>{p.setshowFilterModal(true)}}
          array={p.array} setarray={p.setarray}
          {...p}
          />}
